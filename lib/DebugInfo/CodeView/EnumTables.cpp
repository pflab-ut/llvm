...
static const EnumEntry<unsigned> CPUTypeNames[] = {
    ...
    CV_ENUM_CLASS_ENT(CPUType, MAXIS),
    CV_ENUM_CLASS_ENT(CPUType, MAXIS16),
    CV_ENUM_CLASS_ENT(CPUType, MAXIS32),
    CV_ENUM_CLASS_ENT(CPUType, MAXIS64),
    CV_ENUM_CLASS_ENT(CPUType, MAXISI),
    CV_ENUM_CLASS_ENT(CPUType, MAXISII),
    CV_ENUM_CLASS_ENT(CPUType, MAXISIII),
    CV_ENUM_CLASS_ENT(CPUType, MAXISIV),
    CV_ENUM_CLASS_ENT(CPUType, MAXISV),
