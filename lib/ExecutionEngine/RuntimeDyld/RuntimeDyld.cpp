...
uint8_t *RuntimeDyldImpl::createStubFunction(uint8_t *Addr,
  ...
  if (Arch == Triple::aarch64 || Arch == Triple::aarch64_be) {
    ...
    return Addr + 4;
  } else if (IsMaxisO32ABI || IsMaxisN32ABI) {
    ...
    if ((AbiVariant & ELF::EF_MAXIS_ARCH) == ELF::EF_MAXIS_ARCH_32R6 ||
        (AbiVariant & ELF::EF_MAXIS_ARCH) == ELF::EF_MAXIS_ARCH_64R6)
    ...
    const unsigned NopInstr = 0x0;
    unsigned JrT9Instr = 0x03200008;
    if ((AbiVariant & ELF::EF_MAXIS_ARCH) == ELF::EF_MAXIS_ARCH_64R6)
      JrT9Instr = 0x03200009;
