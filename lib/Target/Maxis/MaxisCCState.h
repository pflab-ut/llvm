//===---- MaxisCCState.h - CCState with Maxis specific extensions -----------===//
//
...
#ifndef MAXISCCSTATE_H
#define MAXISCCSTATE_H
...
class MaxisCCState : public CCState {
public:
  enum SpecialCallingConvType { Maxis16RetHelperConv, NoSpecialCallingConv };
...
private:
  ...
  // Used to handle MAXIS16-specific calling convention tweaks.
  // FIXME: This should probably be a fully fledged calling convention.
  SpecialCallingConvType SpecialCallingConv;

public:
  MaxisCCState(CallingConv::ID CC, bool isVarArg, MachineFunction &MF,
