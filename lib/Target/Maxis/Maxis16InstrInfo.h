//===- Maxis16InstrInfo.h - Maxis16 Instruction Information -------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_MAXIS_MAXIS16INSTRINFO_H
#define LLVM_LIB_TARGET_MAXIS_MAXIS16INSTRINFO_H
...
class Maxis16InstrInfo : public MaxisInstrInfo {
  const Maxis16RegisterInfo RI;

public:
  explicit Maxis16InstrInfo(const MaxisSubtarget &STI);
...
#endif // LLVM_LIB_TARGET_MAXIS_MAXIS16INSTRINFO_H
