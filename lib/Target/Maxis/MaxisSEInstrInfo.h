//===-- MaxisSEInstrInfo.h - Maxis32/64 Instruction Information ---*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_MAXIS_MAXISSEINSTRINFO_H
#define LLVM_LIB_TARGET_MAXIS_MAXISSEINSTRINFO_H
...
class MaxisSEInstrInfo : public MaxisInstrInfo {
  const MaxisSERegisterInfo RI;

public:
  explicit MaxisSEInstrInfo(const MaxisSubtarget &STI);
