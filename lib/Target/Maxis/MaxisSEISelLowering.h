//===- MaxisSEISelLowering.h - MaxisSE DAG Lowering Interface -----*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_MAXIS_MAXISSEISELLOWERING_H
#define LLVM_LIB_TARGET_MAXIS_MAXISSEISELLOWERING_H
...
class TargetRegisterClass;
  ...
  class MaxisSETargetLowering : public MaxisTargetLowering  {
  public:
    explicit MaxisSETargetLowering(const MaxisTargetMachine &TM,
...
#endif // LLVM_LIB_TARGET_MAXIS_MAXISSEISELLOWERING_H
