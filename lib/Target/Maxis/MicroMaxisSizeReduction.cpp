...
llvm::SmallVector<ReduceEntry, 16> MicroMaxisSizeReduce::ReduceTable = {
    ...
    {RT_OneInstr, OpCodes(Maxis::ADDiu, Maxis::ADDIUR1SP_MM),
     ReduceADDIUToADDIUR1SP, OpInfo(OT_Operands02), ImmField(2, 0, 64, 2)},
    {RT_OneInstr, OpCodes(Maxis::ADDiu, Maxis::ADDIUSP_MM), ReduceADDIUToADDIUSP,
     OpInfo(OT_Operand2), ImmField(0, 0, 0, 2)},
    {RT_OneInstr, OpCodes(Maxis::ADDiu_MM, Maxis::ADDIUR1SP_MM),
     ReduceADDIUToADDIUR1SP, OpInfo(OT_Operands02), ImmField(2, 0, 64, 2)},
    {RT_OneInstr, OpCodes(Maxis::ADDiu_MM, Maxis::ADDIUSP_MM),
    ...
    {RT_OneInstr, OpCodes(Maxis::LBu_MM, Maxis::LBU16_MM), ReduceLXUtoLXU16,
     OpInfo(OT_OperandsAll), ImmField(0, -1, 15, 2)},
    {RT_OneInstr, OpCodes(Maxis::LEA_ADDiu, Maxis::ADDIUR1SP_MM),
     ReduceADDIUToADDIUR1SP, OpInfo(OT_Operands02), ImmField(2, 0, 64, 2)},
