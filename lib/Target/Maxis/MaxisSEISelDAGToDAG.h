//===-- MaxisSEISelDAGToDAG.h - A Dag to Dag Inst Selector for MaxisSE -----===//
//
...
#ifndef LLVM_LIB_TARGET_MAXIS_MAXISSEISELDAGTODAG_H
#define LLVM_LIB_TARGET_MAXIS_MAXISSEISELDAGTODAG_H

#include "MaxisISelDAGToDAG.h"

namespace llvm {

class MaxisSEDAGToDAGISel : public MaxisDAGToDAGISel {

public:
  explicit MaxisSEDAGToDAGISel(MaxisTargetMachine &TM, CodeGenOpt::Level OL)
...
FunctionPass *createMaxisSEISelDag(MaxisTargetMachine &TM,
