//===-- llvm/Target/MaxisTargetObjectFile.h - Maxis Object Info ---*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_MAXIS_MAXISTARGETOBJECTFILE_H
#define LLVM_LIB_TARGET_MAXIS_MAXISTARGETOBJECTFILE_H

#include "llvm/CodeGen/TargetLoweringObjectFileImpl.h"

namespace llvm {
class MaxisTargetMachine;
  class MaxisTargetObjectFile : public TargetLoweringObjectFileELF {
