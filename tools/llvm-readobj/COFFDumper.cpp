...
static const EnumEntry<COFF::MachineTypes> ImageFileMachineType[] = {
  ...
  LLVM_READOBJ_ENUM_ENT(COFF, IMAGE_FILE_MACHINE_MAXIS16   ),
  LLVM_READOBJ_ENUM_ENT(COFF, IMAGE_FILE_MACHINE_MAXISFPU  ),
  LLVM_READOBJ_ENUM_ENT(COFF, IMAGE_FILE_MACHINE_MAXISFPU16),
  ...
  LLVM_READOBJ_ENUM_ENT(COFF, IMAGE_FILE_MACHINE_WCEMAXISV2),
