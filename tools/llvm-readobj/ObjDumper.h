...
public:
  ...
  // Only implemented for MAXIS ELF at this time.
  virtual void printMaxisPLTGOT() { }
  virtual void printMaxisABIFlags() { }
  virtual void printMaxisReginfo() { }
  virtual void printMaxisOptions() { }
