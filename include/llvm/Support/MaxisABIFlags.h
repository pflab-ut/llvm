//===--- MaxisABIFlags.h - MAXIS ABI flags ----------------------------------===//
//
...
// in the .MAXIS.abiflags section.
//
// https://dmz-portal.maxis.com/wiki/MAXIS_O32_ABI_-_FR0_and_FR1_Interlinking
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_SUPPORT_MAXISABIFLAGS_H
#define LLVM_SUPPORT_MAXISABIFLAGS_H
...
enum AFL_ASE {
  ...
  AFL_ASE_MAXIS3D = 0x00000020,    // MAXIS-3D ASE
  AFL_ASE_MT = 0x00000040,        // MT ASE
  AFL_ASE_SMARTMAXIS = 0x00000080, // SmartMAXIS ASE
  AFL_ASE_VIRT = 0x00000100,      // VZ ASE
  AFL_ASE_MSA = 0x00000200,       // MSA ASE
  AFL_ASE_MAXIS16 = 0x00000400,    // MAXIS16 ASE
  AFL_ASE_MICROMAXIS = 0x00000800, // MICROMAXIS ASE
...
enum AFL_EXT {
  ...
  AFL_EXT_5900 = 6,         // MAXIS R5900 instruction
  AFL_EXT_4650 = 7,         // MAXIS R4650 instruction
  AFL_EXT_4010 = 8,         // LSI R4010 instruction
  AFL_EXT_4100 = 9,         // NEC VR4100 instruction
  AFL_EXT_3900 = 10,        // Toshiba R3900 instruction
  AFL_EXT_10000 = 11,       // MAXIS R10000 instruction
...
// MAXIS object attribute tags
enum {
  Tag_GNU_MAXIS_ABI_FP = 4,  // Floating-point ABI used by this object file
  Tag_GNU_MAXIS_ABI_MSA = 8, // MSA ABI used by this object file
};

// Values for the fp_abi word of an ABI flags structure
// and for the Tag_GNU_MAXIS_ABI_FP attribute tag.
enum Val_GNU_MAXIS_ABI_FP {
  Val_GNU_MAXIS_ABI_FP_ANY = 0,    // not tagged
  Val_GNU_MAXIS_ABI_FP_DOUBLE = 1, // hard float / -mdouble-float
  Val_GNU_MAXIS_ABI_FP_SINGLE = 2, // hard float / -msingle-float
  Val_GNU_MAXIS_ABI_FP_SOFT = 3,   // soft float
  Val_GNU_MAXIS_ABI_FP_OLD_64 = 4, // -maxis32r2 -mfp64
  Val_GNU_MAXIS_ABI_FP_XX = 5,     // -mfpxx
  Val_GNU_MAXIS_ABI_FP_64 = 6,     // -maxis32r2 -mfp64
  Val_GNU_MAXIS_ABI_FP_64A = 7     // -maxis32r2 -mfp64 -mno-odd-spreg
};

// Values for the Tag_GNU_MAXIS_ABI_MSA attribute tag.
enum Val_GNU_MAXIS_ABI_MSA {
  Val_GNU_MAXIS_ABI_MSA_ANY = 0, // not tagged
  Val_GNU_MAXIS_ABI_MSA_128 = 1  // 128-bit MSA
};
}
}
